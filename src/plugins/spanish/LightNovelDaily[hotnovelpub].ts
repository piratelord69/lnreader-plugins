...
const plugin = new HotNovelPubPlugin({"id":"lightnoveldaily","sourceSite":"https://lightnoveldaily.com","sourceName":"LightNovelDaily","filters":{"sort":{"type":FilterTypes.Picker,"label":"Order","value":"hot","options":[{"label":"Historia caliente","value":"hot"},{"label":"Nuevas cuentos","value":"new"},{"label":"Historia completa","value":"full"}]},"category":{"type":FilterTypes.Picker,"label":"Categoría","value":"","options":[{"label":"NONE","value":""},{"label":"Acción/Aventura","value":"accinaventura"},{"label":"Fantasía","value":"fantasa"},{"label":"Ficción adolescente","value":"ficcin-adolescente"},{"label":"Hombre lobo/Vampiro","value":"hombre-lobovampiro"},{"label":"LGBTQ+","value":"lgbtq"},{"label":"Mafia","value":"mafia"},{"label":"Nuevo Adulto","value":"nuevo-adulto"},{"label":"Pornografía","value":"pornografa"},{"label":"Romántico","value":"romntico"},{"label":"Urbano","value":"urbano"}]}},"options":{"lang":"es"}});
