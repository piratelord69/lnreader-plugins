...
const plugin = new MadaraPlugin({"id":"traducciones","sourceSite":"https://traduccionesamistosas.eyudud.net/","sourceName":"Traducciones Amistosas","options":{"useNewChapterEndpoint":true,"lang":"Spanish"}});
